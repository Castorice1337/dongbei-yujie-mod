...
| 2 | Daipai Core System | Implement the status effect, final-level calculation, periodic damage, and Daipai enchantment. | DAIP-01 through DAIP-05, ENCH-01 through ENCH-04 |
| 3 | Big Sweaty Foot Item | Implement the dual weapon/boots item, combat behavior, enchantment compatibility, and wearer bonuses. | FOOT-01 through FOOT-07 |
